...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="background: linear-gradient(to top, lightgrey, whitesmoke)">
        <center>
            ...
            <p>
                <h4 style="font: bold 50px verdana; padding-top: 4%; padding-bottom: 4%">FAQ</h4>
            </p>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <p>
                        Registering with S&JBoutique.com is easy. You can create a unique account by going through the following steps: 
                ...
                Click on the “Create Account” button for account creation.
                    </p>
                </div>
            </div>
